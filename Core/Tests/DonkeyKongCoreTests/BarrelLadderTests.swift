...
final class BarrelLadderTests: XCTestCase {
    ...
    func barrelOnGirder2(random: RandomSource) -> World {
        ...
        w.barrels.append(Barrel(id: 99, kind: .normal, position: Vector2(x: 80, y: Levels.barrels.girders[2].surfaceY(at: 80)),
    ...
    func testBarrelIgnoresLaddersWhenTheDiceSaysNo() {
        ...
        XCTAssertTrue(w.barrels[0].state == .falling || w.barrels[0].currentGirder == 1,
